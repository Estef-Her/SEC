...
Public Class DAO
    ...
    Shared cotizaciones As Integer
    ...
    Public Shared Function obtenerCotizacionesHombres(anios As Integer, meses As Integer) As DataTable
        ...
        Try
            ...
            'Selecciona el qobs para la tabla de vida segun el anio actual, el sexo y el anio de nacimiento'
            Query = "SELECT cuot_req_hom from sec_des.sec_des_cuotas_req WHERE edad = '" & anios & "' AND mes = '" & meses & "';"
    ...
    Public Shared Function obtenerCotizacionesMujeres(anios As Integer, meses As Integer) As DataTable
        ...
        Try
            ...
            'Selecciona el qobs para la tabla de vida segun el anio actual, el sexo y el anio de nacimiento'
            Query = "SELECT cuot_req_muj from sec_des.sec_des_cuotas_req WHERE edad = '" & anios & "' AND mes = '" & meses & "';"
