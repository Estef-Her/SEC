Public Class Usuario
    ...
    Private tipoTrabajador As Integer
    Private cotizaciones As Integer
    ...
    Public Sub cambiarTipoTrabajador(ByVal valorTrabajador As Integer)
        tipoTrabajador = valorTrabajador
    End Sub

    Public Sub cambiarCotizaciones(ByVal numCotizaciones As Integer)
    ...
    Public Function obtenerTipoTrabajador() As Integer
        Return tipoTrabajador
    End Function

    Public Function obtenerCotizaciones() As Integer
        Return cotizaciones
    End Function
