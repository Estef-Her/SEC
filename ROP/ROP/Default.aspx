                ...
                <ContentTemplate>
                   ...
                   <asp:TextBox ID="campoTextoNacimiento" runat="server" input type="text" class="form-control" placeholder="Nacimiento (dd/mm/aaaa)" data-select="datepicker" AutoCompleteType="Disabled"></asp:TextBox>
                    ...
                    <div class="input-group">
                        ...
                        <asp:TextBox ID="campoTextoCapital" runat="server" input type="text" class="input_txtCapital form-control" placeholder=" Capital de pensión" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                    <p>
                    &nbsp;
                    ...
                    <div class="input-group">
                        <asp:TextBox ID="campoTextoTasa" runat="server" input type="text" class="input_txtTasa form-control" placeholder="Tasa de interés técnica" AutoCompleteType="Disabled"></asp:TextBox>
                        <span class="input-group-addon">%</span>
                    </div>
                    <p>
                    &nbsp;
